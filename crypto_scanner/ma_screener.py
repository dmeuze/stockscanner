...
def run_ma_screener():
    """Run the Moving Average screener"""
    print("Start Moving Average screener...")
    ...
    # Strategy parameters
    strategy_name = "Trendvolgend (MA)"
    description = "MA50 boven MA200 en prijs boven MA50: gezonde uptrend."
